...
public class IssueLoaderTest extends AbstractSpringTest {
    @Autowired
	...
	@Test
    public void canPersistLoadedIssues() throws Exception {
	    loader.reset();
        ...
        assertThat(loader.getStories().size(), is(0));
        assertThat(loader.getBugs().size(), is(0));
	...
	@Test
    public void canLoadFromRepoMultipleTimesWithTheSameResults() throws Exception {
        loader.reset();
