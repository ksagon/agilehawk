...
<edo:inputBase path="${path}" id="${id}" label="${label}" required="${required}" controlGroupClass="${controlGroupClass}" labelClass="${labelClass}"
               readonly="${readonly}" inputOnly="${inputOnly}" colspan="${colspan}">
    <jsp:attribute name="inputField">
        <div class="input-group">
            <edo:inputNumber path="${path}" id="${id}" maxFractionDigits="${maxFractionDigits}" placeholder="${placeholder}"
